...
class InputManager {
	...
	public static int readNum(String message, int condicion) {
	...
	public static int readNumInRange(String message, int min, int max) {
		Scanner sc = new Scanner(System.in);
		String str;
		int num = 0;
		boolean isValid = false;
	...
	public static double readDecimalNum(String message) {
		Scanner sc = new Scanner(System.in);
		String str;
		double num = 0;
		boolean isValid = false;
