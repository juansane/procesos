...
public class App {
    ...
    private static void showOccurrencesNum() {
        System.out.print("\n-------------------------------------------" +
                "\n---------------- Resultado ----------------" +
                "\n-------------------------------------------" +
                "\n\nSe han encontrado " + getOccurrencesNum(path, charString) + " ocurrencias de la palabra "
                + charString + " en el archivo.\n");
        verifyClose();
    }
     ...
     * private static void replaceCharString(String path, String word, String
     * repalceWord) {
     ...
     * do {
     * copyName =
     * InputManager.readString("Inserta el nombre que le quieres dar a la copia") +
     * ".txt";
