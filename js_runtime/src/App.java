...
public class App {
    public static void main(String[] args) throws Exception {
        runtimeExample(args, getPath());
    }

    private static void runtimeExample(String[] args, String path) {
        String miComando = "";
        ...
        try {
            miComando += path; // Unimos el comando a la Ruta.
            Process salida = mRuntime.exec(miComando);
